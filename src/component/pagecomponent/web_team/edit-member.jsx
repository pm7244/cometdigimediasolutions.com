...
const EditMember = () => {
  ...
  const fetchMemberData = async () => {
    try {
      ...
      console.log("API URL:", `${import.meta.env.VITE_CMS_URL}api/getbyidmember/${id}`);
      
      const response = await fetch(`${import.meta.env.VITE_CMS_URL}api/getbyidmember/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_CMS_URL}api/updatebyidmember/${id}`, {
        method: 'PUT',
        headers: {
          ...
          <div className="box">
            ...
            <div className="box-body space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Twitter */}
                <div>
                  <label className="ti-form-label">Twitter URL</label>
                  <input
                    type="url"
                    name="twitter"
                ...
                {/* Facebook */}
                <div>
                  <label className="ti-form-label">Facebook URL</label>
                  <input
                    type="url"
                    name="facebook"
