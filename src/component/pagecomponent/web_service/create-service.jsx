...
const CreateService = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_CMS_URL}api/createservice`, {
        method: "POST",
        headers: {
  ...
  return managerOpener === 1 ? (
    ...
    <div>
      ...
      <PageHeader currentpage="Create Service" activepage="Pages" mainpage="Web Service" />
      
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Create New Service</h5>
            </div>
                        ...
                        {serviceLogo.map((logo, index) => (
                          <div key={index} className="relative">
                            <img
                              ...
                              className="w-full h-20 rounded-sm object-cover border"
                              alt={`Logo ${index + 1}`}
                            />
                            <button
                              type="button"
